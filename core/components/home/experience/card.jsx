...
const CardExperience = ({ experience }) => {
  ...
  return (
    ...
    >
      <article className="gap-5 grid text-gray-600 dark:text-secondary bg-white dark:bg-gray-50/5 rounded-xl border dark:border-gray-50/10 p-8 duration-200 hover:bg-white  hover:border-primary-light dark:hover:border-primary border-secondary/50">
