    ...
    <section id="footer" className="w-full h-full">
      <Wrapper className="flex-col py-10 text-primary-dark dark:text-secondary space-y-5 xl:space-y-0">
        <div className="space-x-5 justify-center items-center flex xl:hidden">
          <LinkedIn className="text-primary-dark duration-300 dark:hover:text-secondary dark:text-primary hover:text-secondary hover:-translate-y-1" />
          <Github className="text-primary-dark duration-300 dark:text-primary dark:hover:text-secondary hover:text-secondary hover:-translate-y-1" />
        </div>
