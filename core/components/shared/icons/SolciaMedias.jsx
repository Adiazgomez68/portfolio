...
import { EMAIL, WHATSAPP } from "../../../utils/constants";

export const Github = ({ className = "", ...rest }) => {
  return (
    <Link href="https://github.com/Adiazgomez68" target="_blank" title="Github">
      <svg
...
export const WhatsApp = (props) => {
  return (
    <Link href={`https://wa.me/57${WHATSAPP}`} title="WhatsApp">
      <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth={0}
