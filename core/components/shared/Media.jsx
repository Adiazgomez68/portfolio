    ...
    >
      <div className="flex flex-col items-center space-y-6 fixed left-28 bottom-0 animate-fade-up">
        <div className="space-y-5 flex-col flex">
          <LinkedIn className="text-primary duration-300 hover:text-secondary hover:-translate-y-1" />
          <Github className="text-primary duration-300 hover:text-secondary hover:-translate-y-1" />
        </div>
        <div className="w-[1px] bg-white h-40"></div>
      </div>

      <div className="flex flex-col items-center space-y-28 fixed right-28 bottom-0 animate-fade-up">
        <a
          className="absolute hover:-translate-y-1 font-light tracking-wider duration-300 text-xs text-primary hover:text-secondary cursor-pointer transition rotate-90"
          href={`mailto:${EMAIL}`}
        >
